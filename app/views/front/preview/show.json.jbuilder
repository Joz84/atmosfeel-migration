json.(@opus, :id, :atmosphere_id, :play_time_id, :title, :abstract, :font_color, :font_family, :language_id, :published)
...
json.musics_attributes @chapters.first.musics
json.voices_attributes @chapters.first.voices
...
json.chapters_attributes @chapters do |chapter| 
